...
const TOKENS_URL = 'https://gist.githubusercontent.com/baboobhaiya/8ba0cdfc6d942e2d828500dee3ff1a16/raw/07dc935f7ebc8e1716296719b8b06ebf5ee977bd/polygon_token_list'
const TOKENS_URL_2 = 'https://raw.githubusercontent.com/trisolaris-labs/tokens/master/lists/1313161554/list.json'
...
async function init() {
  ...
  const allTokens2 = await getAllTokensFromTokenLists2()

  const mergedTokenMap = createMergedTokenMap([...allTokens, ...allTokens2])
...
// @returns Array<Token>
async function getAllTokensFromTokenLists2() {
  const response = await fetch(TOKENS_URL_2)
  const { tokens } = await response.json()
