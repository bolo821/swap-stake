...
const POLYGON_POOLS: StakingTri[] = [
  createPool({
    ID: 0,
    poolId: 0,
    tokens: [ETH[ChainId.POLYGON], USDT[ChainId.POLYGON]],
    stakingRewardAddress: MASTERCHEF_ADDRESS_V1[ChainId.POLYGON],
    lpAddress: '0x4ccd010148379ea531d6c587cfdd60180196f9b1',
    allocPoint: 1
  }),
  createPool({
    ID: 1,
    poolId: 1,
    tokens: [MATIC[ChainId.POLYGON], USDT[ChainId.POLYGON]],
    stakingRewardAddress: MASTERCHEF_ADDRESS_V1[ChainId.POLYGON],
    lpAddress: '0x9b08288c3be4f62bbf8d1c20ac9c5e6f9467d8b7',
    allocPoint: 1
  }),
  createPool({
    ID: 2,
    poolId: 2,
    tokens: [WBTC[ChainId.POLYGON], USDT[ChainId.POLYGON]],
    stakingRewardAddress: MASTERCHEF_ADDRESS_V1[ChainId.POLYGON],
    lpAddress: '0xab4b63bd6c214ce8409fa1b31afa50d4e17597f9',
    allocPoint: 1
  }),
  createPool({
    ID: 3,
    poolId: 3,
    tokens: [USDC[ChainId.POLYGON], USDT[ChainId.POLYGON]],
    stakingRewardAddress: MASTERCHEF_ADDRESS_V1[ChainId.POLYGON],
    lpAddress: '0xdac8a8e6dbf8c690ec6815e0ff03491b2770255d',
    allocPoint: 1
  }),
  createPool({
    ID: 4,
    poolId: 4,
    tokens: [DAI[ChainId.POLYGON], MAI[ChainId.POLYGON]],
    stakingRewardAddress: MASTERCHEF_ADDRESS_V1[ChainId.POLYGON],
    lpAddress: '0x5884ddb0bb109c02150242edf00d0737d78ed61d',
    allocPoint: 1
  })
]
